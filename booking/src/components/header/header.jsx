...
import "./header.css"
import { faBed, faPlane, faCar, faTaxi, faCalendarDays, faPerson, faLocation} from '@fortawesome/free-solid-svg-icons';
    ...
    return(
        <div className="header">
            <div className={type === "list" ? "headerContainer listMode" : "headerContainer"}>
                ...
                { type !== "list" &&
                <> <h1 className="heaerTitle">A lifetime of discounts? It's Genius.</h1>

                <p className="headerDesc">Get rewared for your traves - unlock instant savings of 10% or more with a free Lamabooking account</p>
